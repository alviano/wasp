...
%                   in its label set.
% Facts neg(X,Y,V): edge between X and Y exists and has \neg V 
%                   in its label set.
...
% Assign each node X a color from red, green, blue.  
 ...
 c(X,red) v c(X,green) v c(X,blue) :- v(X). 
...
output = """
{bool(v1), bool(v2), c(0,blue), c(0,green), c(0,red), c(1,blue), c(1,green), c(1,red), c(2,blue), c(2,green), c(2,red), c(3,blue), c(3,green), c(3,red), f(v2), pos(0,1,v1), pos(0,1,v2), pos(0,3,v1), pos(1,2,v1), pos(1,3,v1), pos(2,0,v1), pos(2,3,v1), t(v1), v(0), v(1), v(2), v(3), w}
{bool(v1), bool(v2), c(0,blue), c(0,green), c(0,red), c(1,blue), c(1,green), c(1,red), c(2,blue), c(2,green), c(2,red), c(3,blue), c(3,green), c(3,red), pos(0,1,v1), pos(0,1,v2), pos(0,3,v1), pos(1,2,v1), pos(1,3,v1), pos(2,0,v1), pos(2,3,v1), t(v1), t(v2), v(0), v(1), v(2), v(3), w}
"""
