...
#ifndef BERKMINHEURISTICWITHCACHE_H
#define BERKMINHEURISTICWITHCACHE_H
...
class BerkminHeuristicWithCache : public DecisionStrategy
{
    public:
        inline BerkminHeuristicWithCache( Solver& solver, unsigned int numberOfLearnedClausesToConsider = static_cast< unsigned >( -1 ) );
        virtual ~BerkminHeuristicWithCache();
...
void
BerkminHeuristicWithCache::resetCounters()
{
