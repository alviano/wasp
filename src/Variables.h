...
class Variables
{
    public:
        ...
        inline void setHCComponent( Var v, UnfoundedFreeHC* c ){ assert( variablesData[ v ].hcComponent == NULL || c == NULL ); variablesData[ v ].hcComponent = c; }
        inline Component* getComponent( Var v ) { return variablesData[ v ].component; }
        inline UnfoundedFreeHC* getHCComponent( Var v ) { return variablesData[ v ].hcComponent; }
